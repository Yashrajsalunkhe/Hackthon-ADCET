...
const FAQ = () => {
  const faqData = [
    ...
    { question: 'What is the selection process?', answer: 'Round 1 (Online): Submit your idea on Unstop platform. Top teams will be shortlisted. Round 2 (Offline): Selected teams will participate in the 48-hour offline hackathon at ADCET campus.' },
